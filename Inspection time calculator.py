...
n_pixels = {"Large100":[8192, 5460],
            ...
            "Small100":[5120, 2880],
            "Small40": [5120, 2880]}  # number of pixels [3840, 2160]
...
inspection_list = ["Large100", "Large60", "IRvario", "IRthermol", "IRthermolbad", "Small100", "Small40"]   # [visual, IR]
speed_list = []
time_list = []
...
for i, X in enumerate(param_values):
    Y[i] = X[0] / (X[1] * n_pixels[inspection_type][0] * blur_size_accepted - X[1] ** 2 * shutter_speed[
        inspection_type])
# plt.scatter(np.transpose(param_values)[0], Y)
# plt.show()
